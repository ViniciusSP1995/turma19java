...
public class Teste {
	...
	public static void main(String[] args) {
		...
		Produto prod1 = new Produto("Flauta","XE5001",499.90);
		Revista prod2 = new Revista ("Rolling Stone","JK982F",29.90,"Jann Wenner");
		Roupa prod3 = new Roupa("Blusa","EE2386R",249.00,"Lacoste");
		Math.sqrt(5);
